...
//            bucketName: "video-app-fe-bucket",
...
//    private createDeployment(webAppBucket: s3.IBucket, webDistribution: cloudfront.CloudFrontWebDistribution) {
//     console.log("ello")   
//     new s3Deployment.BucketDeployment(this, "VueAppDeployment", {
//            destinationBucket: webAppBucket,
//            sources: [s3Deployment.Source.asset(path.join(__dirname, "../../vide-oh-fe/dist"), {
//                bundling: {
//                    image: cdk.DockerImage.fromRegistry("public.ecr.aws/docker/library/node:lts"),
//                    local: {
//                        tryBundle(outputDir: string) {
//                         console.log("hello")
//                            spawnSync("npm ci", { cwd: SRC_PATH, stdio: "inherit", shell: true });
//                            spawnSync(`npm run build -- -c ${BUILD_CONFIG} --output-path ${outputDir}`, { cwd: SRC_PATH, stdio: "inherit", shell: true });
//                            return true;
//                        },
//                    },
//                },
